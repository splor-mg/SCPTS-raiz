...
*O Termo de Referência (TR) é uma ferramenta essencial para a seleção pública e, por consequência, para a formalização de parcerias. O TR detalha todos os requisitos do serviço/atividade a ser parcerizado, comunicando, de forma objetiva, a sua estrutura, desde a descrição da política pública da qual este serviço é componente, passando pela contextualização da atividade de interesse, até o planejamento da execução, incluindo seu monitoramento e avaliação, as suas diretrizes físico-financeiras e a justificativa sobre a vantajosidade deste modelo. Ele garante transparência e eficiência na gestão de recursos, visando o interesse público e a qualificação do serviço prestado.*
